  ...
  */
    ...
    await collResumeData.findOne({}).then(result => {
      //console.log(`Successfully found document: ${result.state}.`);
        ...
        var ns = ['shard_0','shard_1'];
          
          
        ns.forEach(namespace => {
          var copiedGBCluster = 0;
          
          collStatistics.find({ "_id.fieldName": "collectionStats","_id.id":namespace}).toArray().then(result2 => {
            ...
            result2.forEach(doc => {
                ...
                copiedGBCluster = copiedGBCluster + parseInt(jsonData.copiedGB,10);
                jsonData.copiedGBcluster = copiedGBCluster;
